...
tf.app.flags.DEFINE_bool('add_paragraph_symbols', False, 'Add paragraph symbols to text.')
...
tf.app.flags.DEFINE_integer('min_section_len', 3, 'Minimum number of words in generated section.')
